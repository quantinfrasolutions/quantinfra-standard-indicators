...
/// </summary>
public class BollingerLower : AbstractIndicator
{
    ...
    public BollingerLower(AbstractIndicator source = null, int period = 9, double coef = 1.5)
    {
        ...
        Id = $"BollingerLower:{_period}:{_coef}({source.Id})";
    }
